            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  Building Real-Time Web Applications with React, Next.js, Node.js, and Socket.io
                  </div>
                  {/* JOB DESC */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                  Multi-Service Web Application with Docker and CI/CD Pipeline{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                  DevOps: Automate, Integrate, Innovate, Scale{" "}
                  </div>
                  {/* JOB COMPANY */}
